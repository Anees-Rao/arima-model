...
var Module = (function () {
    ...
    return (function (Module) {
        ...
        function instantiateSync(file, info) { var instance; var module; var binary; try {
        ...
        } var result = instantiateSync(wasmBinaryFile, info); receiveInstance(result[0]); return Module["asm"]; }
        ...
        var asm = createWasm();
        var ___wasm_call_ctors = Module["___wasm_call_ctors"] = asm["f"];
        var _fit_sarimax = Module["_fit_sarimax"] = asm["h"];
        var _predict_sarimax = Module["_predict_sarimax"] = asm["i"];
        var _fit_autoarima = Module["_fit_autoarima"] = asm["j"];
        var _predict_autoarima = Module["_predict_autoarima"] = asm["k"];
        var stackSave = Module["stackSave"] = asm["l"];
        var stackRestore = Module["stackRestore"] = asm["m"];
        var stackAlloc = Module["stackAlloc"] = asm["n"];
        Module["ccall"] = ccall;
        Module["cwrap"] = cwrap;
        var calledRun;
